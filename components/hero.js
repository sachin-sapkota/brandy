  ...
  return (
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2 lg:pl-10">
          <div className="max-w-2xl mb-16">
            <h1 className="text-4xl lg:font-black font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl font-sans xl:leading-tight dark:text-white ">
              Boost Your Online Presence with{' '}
              <u className="underline  underline-offset-[4px] text-blue-700 ">
                Brandy
              </u>
            </h1>
